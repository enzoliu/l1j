...
public abstract class CharactersItemStorage {
	...
	//屬性強化捲軸
	public abstract void updateItemAttribute(L1ItemInstance item) throws Exception;

	public abstract void updateItemAttributeLevel(L1ItemInstance item) throws Exception;
	//~屬性強化捲軸
	//TODO 飾品強化卷軸
	...
	public abstract void updateGetHp(L1ItemInstance item)
	throws Exception;
	public abstract void updateGetMp(L1ItemInstance item)
	throws Exception;
	//~武器吸血吸魔魔法卷軸 by eric1300460
