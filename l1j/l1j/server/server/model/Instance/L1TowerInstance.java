...
public class L1TowerInstance extends L1NpcInstance {
	...
	class Death implements Runnable {
		...
		@Override
		public void run() {
			npc.setDeathProcessing(true);
			npc.setCurrentHpDirect(0);
			npc.setDead(true);
			npc.setStatus(ActionCodes.ACTION_TowerDie);
			...
			npc.setDeathProcessing(false);
			if((npc.getNpcTemplate().get_npcId() == 46160)|| (npc.getNpcTemplate().get_npcId() == 46161)){
