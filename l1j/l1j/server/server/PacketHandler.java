...
public class PacketHandler {
	...
	public void handlePacket(byte abyte0[], L1PcInstance object)
		...
		case C_OPCODE_CHANGE_WAR_TIME://58	
			new C_ChangeWarTime(abyte0, _client);
			break;
			
		
		case C_OPCODE_CHANGE_WAR_TIME_AC2://98	
			new C_ChangeWarTime_AC2(abyte0, _client);
			break;
		//~設定攻程時間
		...
		default:
			L1World.getInstance().broadcastServerMessage("unknown byte=" + abyte0);
