...
public class L1EtcItem extends L1Item {
	...
	private int _read_type;
	
	private String _use_class;
	@Override
	...
	public void set_read_type(int readtype){
		_read_type = readtype;
	}
	
	public int get_read_type(){
		return _read_type;
	}
	
	public void set_use_class(String use_class){
		_use_class = use_class;
	}
	public String get_use_class(){
		return _use_class;
	}
}
